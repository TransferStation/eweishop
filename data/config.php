...
$config['db']['master']['username'] = 'jiuyouhui';
$config['db']['master']['password'] = 'jiuyouhui';
$config['db']['master']['port'] = '3306';
$config['db']['master']['database'] = 'jiuyouhui';
...
$config['setting']['authkey'] = '8d4cce8e';
